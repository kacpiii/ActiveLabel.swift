...
@IBDesignable open class ActiveLabel: UILabel {
    ...
    open func handleEmptyTap(_ handler: @escaping () -> ()) {
        emptyTapHandler = handler
    }
    ...
    fileprivate func didEmptyTap() {
        guard let emptyHandler = emptyTapHandler else { return }
